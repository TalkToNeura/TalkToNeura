...
export class LocalStoragePersonalityProvider implements PersonalityStorageProvider {
    ...
    constructor(agentId: string) {
        this.storageKey = `talktoneura_personality_${agentId}`;
    }
...
/**
 * Default Neura personality configuration
 */
export const NEURA_PERSONALITY: AgentPersonality = {
    agent: {
        id: 'default_agent',
        name: 'Neura',
